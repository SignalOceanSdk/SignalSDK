from signal_ocean.vessel_emissions.models import Emissions, EmissionsEstimationModel, EmissionsBreakdown, \
    VesselClassEmissions, VesselClassMetrics, VesselMetrics, Aer, Cii

__mock_emissions_response_vessel_class_1 = {
...
__mock_emissions_vessel_class_1 = VesselClassEmissions(
