from signal_ocean.tonnage_list import VesselFilter
from datetime import date


def test_converts_to_query_string() -> None:
...
def test_converting_to_query_string_handles_missing_values() -> None:
    vessel_filter = VesselFilter(
        push_types=None,
