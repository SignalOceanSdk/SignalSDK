...
class Column(metaclass=IterableConstants):
    ...
    def _create_row(
        ...
        length_overall: Optional[float],
        breadth_extreme: Optional[int],
        subclass: Optional[str],
        market_deployment: Optional[str],
        push_type: Optional[str],
        open_port_id: Optional[int],
        ...
        open_prediction_accuracy: Optional[str],
        open_country: Optional[str],
        open_narrow_area: Optional[str],
        open_wide_area: Optional[str],
        availability_port_type: Optional[str],
        availability_date_type: Optional[str],
        fixture_type: Optional[str],
        current_vessel_sub_type_id: Optional[int],
        current_vessel_sub_type: Optional[str],
        willing_to_switch_current_vessel_sub_type: Optional[bool],
    ) -> DataFrameRow:
        return (
            name,
            vessel_class,
