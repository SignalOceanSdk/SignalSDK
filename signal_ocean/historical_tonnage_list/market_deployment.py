...
class MarketDeployment(metaclass=IterableConstants):
    ...
    spot market and are advertised through Tonnage lists and get reported fixtures 
    '''
    PROGRAM = 'Program'
    '''
    Vessels controlled by charterers like 
    that do not participate in the spot market and are either not advertised through
    Tonnage lists or tonnage lists report the fact that they are program 
    '''
    RELET = 'Relet'
    '''
