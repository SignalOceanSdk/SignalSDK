...
class VoyageCondensed(Voyage):
    ...
    Attributes:
            ...
            starting_port_id: Numeric ID corresponding to the port where the
                    ...
                    received AIS (for a new building). Voyages are consecutive
                    and with no breaks in between, therefore a vessel is always
                    in a voyage.
            ...
            first_load_arrival_date: Date, format YYYY-MM-DD HH:MM:SS. The
                    ...
                    waiting time. The arrival date of a port call is calculated
                    based on the first AIS point within the event. If the
                    vessel waits in an anchorage area for days, this waiting
                    time is captured as the difference between the
                    FirstLoadArrivalDate and the FirstLoadStartTimeOfOperation.
            ...
            first_load_area_id_level0: Numeric ID corresponding to the level 0
                    area where the vessel performed the first loading operation
                    of the voyage. Level 0 areas offer a detailed breakdown of
                    the globe to the areas of maritime interest.
            first_load_area_name_level0: String, name of the area where the
                    vessel performed the first loading operation of the voyage.
                    Level 0 areas offer a detailed breakdown of the globe to
                    the areas of maritime interest. Examples of level 0 areas
            ...
            last_discharge_area_name_level0: String, name of the area where
                    ...
                    globe to the areas of maritime interest. Examples of
                    level 0 areas include "Arabian Gulf", "US Gulf" and
                    "East Mediterranean".
