...
mcp = FastMCP(
    ...
    lifespan=_lifespan,
    instructions=(
        "Signal Ocean provides maritime shipping data APIs via 69 tools grouped below.\n"
        "All tools require SIGNAL_OCEAN_API_KEY set as an environment variable.\n\n"
        "VESSELS: search_vessel_imos, search_vessels, get_vessel, get_vessel_by_name, "
        "get_vessels_by_vessel_class, get_vessels_by_operator, get_vessel_classes, "
        "get_vessel_types, get_vessel_name_history, get_vessel_commercial_operator_history, "
        "get_vessel_flag_history\n\n"
        "VOYAGES: get_voyages, get_voyages_condensed, get_voyages_flat, "
        "get_voyages_advanced_search, get_latest_completed_voyage\n\n"
        "EMISSIONS: get_vessel_emissions, get_voyage_emissions, get_vessel_class_emissions, "
        "get_vessel_emission_metrics, get_vessel_class_emission_metrics, "
        "get_latest_voyage_emissions, get_vessel_emission_benchmark\n\n"
        "CONSUMPTIONS: get_vessel_consumptions, get_vessel_advertised_consumptions\n\n"
        "VALUATIONS: get_vessel_valuation, get_vessel_historical_valuations, "
        "get_vessel_valuations_for_list, get_vessel_valuations_paged, "
        "get_vessel_valuations_for_class\n\n"
        "MARKET & FREIGHT RATES: get_market_rates, get_market_rate_routes, "
        "get_market_rates_by_route_name, get_freight_rates, get_freight_rate_vessel_classes, "
        ...
        "TONNAGE LISTS & SUPPLY: get_tonnage_list, get_historical_tonnage_list, "
        "get_tonnage_list_ports, get_tonnage_list_and_market_rates, get_vessel_supply\n\n"
        "SCRAPED MARKET DATA: get_scraped_cargoes, get_scraped_fixtures, "
        "get_scraped_lineups, get_scraped_positions\n\n"
        "GEOGRAPHY & COMPANIES: get_ports_geo, get_countries, get_areas, "
        "get_geo_assets, get_company, search_companies"
    ),
)
